  ...
  return (
    <Timeline lineColor={"#ddd"}>
      ...
      <TimelineItem key="003" dateText="1926">
        ...
        <p className="my-2">
          After several failed attempts to call a full-time campus pastor, Rev.
          Schroedel of Mt. Olive Lutheran Church, Minneapolis, agreed to serve
          part-time. Bible studies were organized on campus and students were
          encouraged to attend services at local congregations.
        </p>
      ...
      <TimelineItem key="004" dateText="1934">
        ...
        <p className="my-2">
          Gamma Delta, the International Association for Lutheran Students, was
          founded with the U of M group as the Gamma Chapter. Gamma Delta became
          an important spiritual and social outlet for hundreds of students,
          many of whom met their spouses through the organization and its
          activities. Pictured are Gamma Delta leaders with Pastor Schroedel in
          1939.
        </p>
      ...
      <TimelineItem key="005" dateText="1940">
        ...
        <p className="my-2">
          ...
          The Lutheran Hour, helped with pastoral duties while he was completing
          his doctorate at the U of M.
        </p>
      ...
      <TimelineItem key="007" dateText="1940">
        ...
        <p className="my-2">
          ...
          campus ministry for eleven years. Under his leadership the Gamma Delta
          group continued to grow and flourish. In 1951 Pastor Nordan was called
          to serve the LC-MS at its national office of campus ministry.
        </p>
      ...
      <TimelineItem key="008" dateText="1945">
        ...
        <p className="my-2">
          Gamma Delta continued to grow and thrive. Here are the leaders of 1945
          with Pastor Norden.
        </p>
      ...
      <TimelineItem key="011" dateText="1949">
        ...
        <p className="my-2">
          Ground-breaking for the chapel took place on March 27, 1949. Delegates
          to the convention of the Minnesota District of the LC-MS took a recess
          from their sessions at Concordia College, St. Paul, to come to ULC for
          the laying of the cornerstone on August 16th, 1949.
        </p>
      ...
      <TimelineItem key="012" dateText="1950">
        ...
        <p className="my-2">
          Our newly built chapel was dedicated in a series of three services on
          Quasimodogeniti Sunday, April 16, 1950.
        </p>
      ...
      <TimelineItem key="015" dateText="1952">
        ...
        <p className="my-2">
          ULC has a long tradition of inviting expert pastors and theologians to
          teach our students.
        </p>
      ...
      <TimelineItem key="018" dateText="1954">
        ...
        <p className="my-2">
          Pastor Beisel served ULC until 1959 when he was called to be President
          of St. John’s College in Winfield, Kansas.
        </p>
      ...
      <TimelineItem key="020" dateText="1954">
        ...
        <p className="my-2">
          ...
          second Sunday service was added to handle the large number of people.
        </p>
      ...
      <TimelineItem key="021" dateText="1955">
        ...
        <p className="my-2">
          ...
          Minnesota District In August of 1955 the Minnesota Convention accepted
          ULC as an official congregation of the Lutheran Church-Missouri Synod.
          Pictured are students gathered for a candlelight vespers service.
        </p>
      ...
      <TimelineItem key="024" dateText="1956">
        ...
        <p className="my-2">
          Music is a big part of ULC's worship life. The choir was so popular in
          the 1950s that they regularly put on concerts and even recorded an
          album.
        </p>
      ...
      <TimelineItem key="025" dateText="1957">
        ...
        <p className="my-2">
          Gamma Delta's Sunday Evening meetings which included a Vespers service
          were very popular.
        </p>
      ...
      <TimelineItem key="026" dateText="1957">
        ...
        <p className="my-2">
          Students enjoyed meals in the Chapel's undercroft on weekends when the
          dormitory cafeterias were closed.
        </p>
      ...
      <TimelineItem key="027" dateText="1960">
        ...
        <p className="my-2">
          ...
          wrote the daily service book Bless We The Lord, published by Concordia
          Publishing House in 1963, which became the pattern for The Priesthood
          Prays, still in use at ULC today. Weekly communion began to be offered
          after Easter of 1960.
        </p>
      ...
      <TimelineItem key="033" dateText="1973">
        ...
        <p className="my-2">
          ...
          outreach and student worship. The LCMS ended these arrangements in the
          early 1980’s.
        </p>
      ...
      <TimelineItem key="034" dateText="1983">
        ...
        <p className="my-2">
          ...
          split with the ALC, Pastor Pless worked for 17 years to restore ULC to
          its confessional roots and rebuild the student ministry.
        </p>
      ...
      <TimelineItem key="035" dateText="1987">
        ...
        <p className="my-2">
          The chapel grew and matured under Pastor Pless’s able leadership, and
          returned to fulfilling its original purpose of being a haven and a
          stabilizing influence in the lives of the students who attend.
        </p>
      ...
      <TimelineItem key="037" dateText="1995">
        ...
        <p className="my-2">
          ...
          preaching seminars, the lay academy of theology; a restoration of the
          chapel to its original orientation; and outreach to international
          students through the ISCRC.
        </p>
      ...
      <TimelineItem key="039" dateText="2000">
        ...
        <p className="my-2">
          Pastor Jastram served as Vacancy Pastor after Pastor Pless was called
          to teach at Concordia Theological Seminary in Fort Wayne, Indiana.
        </p>
      ...
      <TimelineItem key="041" dateText="2001">
        ...
        <p className="my-2">
          ...
          congregation of the synod to call a pastor. Pastor Kind became campus
          pastor in April of 2001.
        </p>
      ...
      <TimelineItem key="045" dateText="2010">
        ...
        <p className="my-2">
          ...
          year. In 2011 a new international student outreach effort was started.
        </p>
      ...
      <TimelineItem key="047" dateText="2012">
        ...
        <p className="my-2">
          In September of 2011 the MN South District Board of Directors sold the
          chapel property to make way for luxury student apartments. This action
          was the culmination of three decades of strife with the district
          leadership over ULC’s confessional and liturgical approach to campus
          ministry. The chapel was deconsecrated on June 24, 2012 &#40;Nativity
      ...
      <TimelineItem key="048" dateText="2012">
        ...
        <p className="my-2">
          ...
          continued to grow and thrive in exile, holding services off campus at
          Luther Seminary's Chapel of the Cross.
        </p>
      ...
      <TimelineItem key="049" dateText="2013">
        ...
        <p className="my-2">
          In order to reestablish its presence at the U of M and further efforts
          in campus ministry, ULC purchased and renovated the former Delta Delta
          Delta sorority house. Luther House was dedicated on April 5, 2013, and
          is now home to all of ULC's weekday services and activities.
        </p>
      ...
      <TimelineItem key="051" dateText="2015">
        <h2 className="text-2xl">FALL RETREAT</h2>
        <p className="my-2">
          In spite of being without a chapel, our campus congregation has grown
          in to a congregation of some 140 souls from all around the Twin Cities
          &#40;and even as far as Eau Claire, WI!&#41; who have made ULC their
          spiritual home.
        </p>
      ...
      <TimelineItem key="054" dateText="2019">
        ...
        <p className="my-2">
          Construction wrapped up in August. The new University Lutheran Chapel
          was dedicated on September 8 with an opening Divine Service in the
          morning and a Vespers service in the afternoon. Over 500 students,
          members, friends and alumni attended.
        </p>
